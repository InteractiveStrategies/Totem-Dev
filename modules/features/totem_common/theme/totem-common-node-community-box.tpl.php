...
<?php else: ?>
  ...
  <?php elseif ($hook == 'user_community_recent'): ?>
    ...
    <div class="bd clearfix">
      <?php if ($filtered_subscribed): ?>
        <div class="activity-welcome subscribed">
          <h3>You have not subscribed to any content yet.</h3>
          <p><?php print t("Click the \"Subscribe\" link on interesting posts in your @community to follow their activity here.", array('@community' => t("Communities"))); ?></p>
        </div>
      <?php else: ?>
